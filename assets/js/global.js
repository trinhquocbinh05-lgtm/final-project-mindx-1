...
// ============================================
// BƯỚC 5: CHỨC NĂNG TOGGLE SIDEBAR
// ============================================
...
if (sidebarToggleBtn && sidebar) {
  ...
  // Load trạng thái sidebar đã lưu khi tải trang
  const savedState = localStorage.getItem('sidebarCollapsed') === 'true';
  applySidebarState(savedState);
  console.log('✅ Applied sidebar state:', savedState ? 'collapsed' : 'expanded');
}
